...
#define ATM_PRIO_Q_NUM		ATM_PVC_NUMBER
#define ATM_TX_Q_NUM		15

#define ATM_PDBRAM_US_BUF_LEN	32
...
#define TOTAL_QOS_DES_NUM	(__US_QOSQ_DES_LIST_PERQ_NUM	\
					* __US_QOSQ_DES_LIST_NUM_Q)
